      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <a href="https://www.circle.com/en/usdc" target="_blank" rel="noopener" className="text-[#01C38E] text-sm hover:text-[#0A786A]">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <a href="https://arc.network" target="_blank" rel="noopener" className="text-[#01C38E] text-sm hover:text-[#0A786A]">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <a href="https://docs.openzeppelin.com/contracts" target="_blank" rel="noopener" className="text-[#01C38E] text-sm hover:text-[#0A786A]">
