  ...
  return (
    <div className="prose prose-invert max-w-none">
      ...
      <section className="mb-12">
        ...
        <div className="bg-gradient-to-br from-[#01C38E]/10 to-[#0A786A]/10 border border-[#01C38E]/20 rounded-xl p-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between"><span className="text-gray-400">RPC URL:</span><span className="text-[#01C38E] font-mono text-xs">rpc.testnet.arc.network</span></div>
            ...
            <div>
              ...
              <a href="https://testnet.arcscan.app" target="_blank" rel="noopener" className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-lg text-[#01C38E] hover:bg-white/20 transition-colors">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="px-2 py-0.5 text-xs bg-[#0A786A]/20 text-[#01C38E] rounded-full">Active</span>
                  </div>
                </div>
              </div>
              <a 
                ...
                target="_blank" 
                rel="noopener" 
                className="flex items-center gap-2 text-[#01C38E] font-mono text-sm hover:text-[#01C38E] transition-colors"
              >
              ...
              {contract.functions.map((fn) => (
                <div key={fn.name} className="p-3 bg-white/5 rounded-lg border border-white/5">
                  <div className="flex items-start justify-between gap-4">
                    <code className="text-[#0A786A] text-sm">
            ...
            <tbody className="divide-y divide-white/10">
              <tr>
                ...
                <td className="px-4 py-3">
                  <a href="https://testnet.arcscan.app/address/0x3600000000000000000000000000000000000000" target="_blank" rel="noopener" className="text-[#01C38E] font-mono text-sm hover:text-[#01C38E]">
                    0x3600...0000
                  </a>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="px-4 py-3">
                  <a href="https://testnet.arcscan.app/address/0x94e0dc7AD29b94EC9819f6cEC3364DD34f41b3c6" target="_blank" rel="noopener" className="text-[#01C38E] font-mono text-sm hover:text-[#01C38E]">
                    0x94e0...b3c6
                  </a>
                </td>
              </tr>
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div>
                  ...
                  <a href="https://testnet.arcscan.app/address/0x3600000000000000000000000000000000000000" target="_blank" rel="noopener" className="block text-[#01C38E] font-mono hover:text-[#01C38E] truncate">
                    0x3600...0000
                  </a>
                </div>
                <div>
                ...
                <div>
                  ...
                  <a href="https://faucet.circle.com" target="_blank" rel="noopener" className="block text-[#01C38E] hover:text-[#01C38E]">
                    faucet.circle.com
                  </a>
                </div>
              </div>
        ...
        <div className="space-y-4">
          <div className="bg-white/5 border border-white/10 rounded-xl p-5">
            <h4 className="text-white font-semibold mb-3 flex items-center gap-2">
              <span className="text-[#01C38E]">📤</span> TipSent
            </h4>
...
{`event TipsClaimed(
    ...
    uint256 timestamp
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5">
            <h4 className="text-white font-semibold mb-3 flex items-center gap-2">
              <span className="text-[#0A786A]">🔗</span> WalletLinked
            </h4>
            <div className="bg-[#0a0b0f] rounded-lg p-4 font-mono text-xs overflow-x-auto">
              <pre className="text-gray-300">
{`event WalletLinked(
