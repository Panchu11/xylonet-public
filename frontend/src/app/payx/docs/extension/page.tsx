    ...
    <div className="prose prose-invert max-w-none">
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="p-5 bg-gradient-to-br from-[#01C38E]/10 to-[#01C38E]/5 border border-[#01C38E]/20 rounded-xl">
          ...
          <div className="p-5 bg-gradient-to-br from-[#0A786A]/10 to-[#0A786A]/5 border border-[#0A786A]/20 rounded-xl">
            <div className="text-3xl mb-3">👛</div>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          {/* Chrome Web Store - Available Now */}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="px-2 py-0.5 text-xs bg-green-500/20 text-green-400 rounded-full">Available Now</span>
                </div>
                <p className="text-gray-400 text-sm mb-4">
                  Install PayX directly from the Chrome Web Store with one click.
                </p>
                <a 
                  href="https://chromewebstore.google.com/detail/lfnlmagjbpmgjbekebhgnjklpjhnjigi"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/20 hover:bg-green-500/30 text-green-400 rounded-lg transition-colors font-semibold text-sm"
                >
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">🔧</span> Manual Installation (Alternative)
            </h3>
            <p className="text-gray-400 text-sm mb-4">For developers or if you prefer manual installation:</p>
            <ol className="space-y-4 text-gray-300">
              <li className="flex items-start gap-3">
                <span className="text-[#01C38E] font-bold">1.</span>
                <div>
                  <span>Download the extension folder from the repository</span>
                  <p className="text-xs text-gray-500 mt-1">Located at: <code className="text-[#01C38E]">/payx/apps/extension</code></p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#01C38E] font-bold">2.</span>
                <span>Open Chrome and go to <code className="text-[#01C38E] bg-[#0A786A]/10 px-2 py-0.5 rounded">chrome://extensions/</code></span>
              </li>
              <li className="flex items-start gap-3">
      ...
      <section>
        ...
        <div className="bg-gradient-to-r from-[#0A786A]/10 to-[#01C38E]/10 border border-[#0A786A]/20 rounded-xl p-6">
          <div className="flex items-center justify-between">
            <div>
            ...
            <div className="flex items-center gap-2">
              <span className="px-3 py-1 bg-[#01C38E]/20 text-[#01C38E] rounded-full text-sm font-mono">v2.0.0</span>
            </div>
          </div>
          <div className="mt-4 pt-4 border-t border-white/10">
            <p className="text-xs text-gray-500">
              Built by <span className="text-[#01C38E] font-semibold">ForgeLabs</span> • Powered by Arc Network
            </p>
          </div>
        </div>
      </section>
