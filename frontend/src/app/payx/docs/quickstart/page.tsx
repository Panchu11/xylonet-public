    ...
    <div className="prose prose-invert max-w-none">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="w-8 h-8 rounded-full bg-[#0A786A]/20 flex items-center justify-center text-[#0A786A] text-sm font-bold">🎁</span>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6">
          <ol className="space-y-4 text-gray-300">
            <li className="flex items-start gap-3">
              ...
              <span>Visit <a href="/payx/claim" className="text-[#01C38E] hover:text-[#01C38E]">PayX Claim Page</a></span>
            </li>
            <li className="flex items-start gap-3">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
          <span className="w-8 h-8 rounded-full bg-[#01C38E]/20 flex items-center justify-center text-[#01C38E] text-sm font-bold">💸</span>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <ol className="space-y-3 text-gray-300">
              <li className="flex items-start gap-3">
                <span className="text-[#01C38E] font-bold">1.</span>
                <span>Install the PayX extension from the <a href="https://chromewebstore.google.com/detail/lfnlmagjbpmgjbekebhgnjklpjhnjigi" target="_blank" rel="noopener" className="text-[#01C38E] hover:text-[#01C38E]">Chrome Web Store</a></span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#01C38E] font-bold">2.</span>
          ...
          {/* Step 2: Get USDC */}
          <div className="bg-gradient-to-r from-[#01C38E]/10 to-[#0A786A]/10 border border-[#01C38E]/30 rounded-xl p-6">
            ...
            <ol className="space-y-3 text-gray-300">
              <li className="flex items-start gap-3">
                <span className="text-[#01C38E] font-bold">1.</span>
                <span>Visit <a href="https://faucet.circle.com" target="_blank" rel="noopener" className="text-[#01C38E] hover:text-[#01C38E]">Circle&apos;s USDC Faucet</a></span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#01C38E] font-bold">2.</span>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <ol className="space-y-3 text-gray-300">
              <li className="flex items-start gap-3">
                <span className="text-[#01C38E] font-bold">1.</span>
                <span>Go to <a href="https://x.com" target="_blank" rel="noopener" className="text-[#01C38E] hover:text-[#01C38E]">X.com</a> and find a tweet you want to tip</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#01C38E] font-bold">2.</span>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-4 bg-white/5 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between"><span className="text-gray-400">RPC URL:</span><span className="text-[#01C38E] font-mono text-xs break-all">https://rpc.testnet.arc.network</span></div>
            ...
            <div className="p-4 bg-white/5 rounded-lg">
              ...
              <a href="https://testnet.arcscan.app" target="_blank" rel="noopener" className="inline-flex items-center gap-2 text-[#01C38E] hover:text-[#01C38E]">
                testnet.arcscan.app
        ...
        <div className="bg-gradient-to-r from-[#01C38E]/10 to-[#0A786A]/10 border border-[#01C38E]/30 rounded-xl p-6">
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-center gap-3">
              ...
              <a href="/docs/tipping" className="hover:text-[#01C38E] transition-colors">Learn how tipping works in detail</a>
            </li>
            <li className="flex items-center gap-3">
              <span className="text-[#01C38E]">→</span>
              <a href="/docs/extension" className="hover:text-[#01C38E] transition-colors">Explore extension features</a>
            </li>
            <li className="flex items-center gap-3">
              <span className="text-[#01C38E]">→</span>
              <a href="/docs/contracts" className="hover:text-[#01C38E] transition-colors">View smart contract details</a>
            </li>
            <li className="flex items-center gap-3">
              <span className="text-[#01C38E]">→</span>
              <a href="/docs/faq" className="hover:text-[#01C38E] transition-colors">Check frequently asked questions</a>
            </li>
          </ul>
        </div>
      </section>
