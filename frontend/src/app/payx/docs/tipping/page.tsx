    ...
    <div className="prose prose-invert max-w-none">
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          <div className="p-5 bg-gradient-to-br from-[#01C38E]/10 to-[#01C38E]/5 border border-[#01C38E]/20 rounded-xl text-center">
            <div className="w-12 h-12 bg-[#01C38E]/20 rounded-xl flex items-center justify-center mx-auto mb-4">
          ...
          <div className="p-5 bg-gradient-to-br from-[#0A786A]/10 to-[#0A786A]/5 border border-[#0A786A]/20 rounded-xl text-center">
            <div className="w-12 h-12 bg-[#0A786A]/20 rounded-xl flex items-center justify-center mx-auto mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {['$1', '$2', '$5', '$10'].map((amount) => (
                  <div key={amount} className="px-4 py-2 bg-[#01C38E]/20 border border-[#0A786A]/30 rounded-lg text-[#01C38E] font-semibold">
                    {amount}
                  </div>
                ))}
              </div>
        ...
        <div className="space-y-4">
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-2xl font-bold text-[#01C38E]">1%</div>
            </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6">
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-4">
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 bg-[#01C38E]/20 rounded-full flex items-center justify-center text-[#01C38E] text-sm">💬</div>
              <div>
      ...
      <section className="mb-12">
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6">
          <p className="text-gray-300 mb-4">
            Every tip emits a <code className="text-[#01C38E] bg-[#0A786A]/10 px-2 py-0.5 rounded">TipSent</code> event containing:
          </p>
...
{`event TipSent(
    ...
    uint256 timestamp           // Block timestamp
          ...
          <p className="text-sm text-gray-400 mt-4">
            ...
            <a href="https://testnet.arcscan.app/address/0xA312c384770B7b49E371DF4b7AF730EFEF465913" target="_blank" rel="noopener" className="text-[#01C38E] hover:text-[#0A786A]">
              ArcScan
            </a>.
          </p>
        </div>
