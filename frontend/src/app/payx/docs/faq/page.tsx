      ...
      questions: [
        {
          ...
          a: 'The PayX extension is available on the Chrome Web Store! Visit https://chromewebstore.google.com/detail/lfnlmagjbpmgjbekebhgnjklpjhnjigi to install it with one click.'
        },
        {
  ...
  return (
    <div className="prose prose-invert max-w-none">
      ...
      <section className="mt-12">
        <div className="bg-gradient-to-r from-[#01C38E]/10 to-[#0A786A]/10 border border-[#01C38E]/30 rounded-xl p-6 text-center">
