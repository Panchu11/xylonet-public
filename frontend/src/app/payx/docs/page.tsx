    ...
    <div>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <Link href="/payx/docs/tipping" className="block p-5 bg-gradient-to-r from-[#01C38E]/5 to-transparent border border-white/5 hover:border-[#01C38E]/30 rounded-xl transition-all group">
          ...
          <Link href="/payx/docs/claiming" className="block p-5 bg-gradient-to-r from-[#0A786A]/5 to-transparent border border-white/5 hover:border-[#0A786A]/30 rounded-xl transition-all group">
            <div className="flex items-start gap-4">
