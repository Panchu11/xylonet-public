...
const navigation = [
  {
    ...
    items: [
      { name: 'Introduction', href: '/payx/docs' },
      { name: 'Quick Start', href: '/payx/docs/quickstart' },
    ],
  },
  {
    title: 'Features',
    items: [
      { name: 'How Tipping Works', href: '/payx/docs/tipping' },
      { name: 'Claiming Tips', href: '/payx/docs/claiming' },
      { name: 'Chrome Extension', href: '/payx/docs/extension' },
    ],
  },
  {
    title: 'Technical',
    items: [
      { name: 'Smart Contract', href: '/payx/docs/contracts' },
      { name: 'Security', href: '/payx/docs/security' },
    ],
  },
  {
    title: 'Support',
    items: [
      { name: 'FAQ', href: '/payx/docs/faq' },
    ],
  },
];
      ...
      <header className="sticky top-0 z-50 bg-[#0f172a]/95 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-6">
            <Link href="/payx" className="flex items-center gap-2.5 group">
              <div className="relative">
                <div className="relative w-9 h-9 rounded-lg bg-[#1e293b] border border-white/10 flex items-center justify-center overflow-hidden">
                  <Image src="/branding/payx/payx-icon-gradient.svg" alt="PayX" width={24} height={24} />
                </div>
              </div>
      ...
      <div className="max-w-[1600px] mx-auto flex">
        ...
        <aside className="hidden lg:block w-64 shrink-0 border-r border-white/5">
          <nav className="sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto py-8 px-4">
            ...
            <div className="mt-8 pt-6 border-t border-white/5">
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <span className="text-xs bg-white/5 px-1.5 py-0.5 rounded text-gray-600">Coming Soon</span>
                </div>
                <a
            ...
            {/* ForgeLabs Credit */}
            <div className="mt-8 pt-6 border-t border-white/5">
              <div className="px-3 py-3 bg-gradient-to-r from-[#0A786A]/5 to-[#01C38E]/5 border border-[#01C38E]/10 rounded-xl">
                <div className="text-xs text-gray-500 mb-1">Built by</div>
                <div className="text-sm font-semibold bg-gradient-to-r from-[#0A786A] to-[#01C38E] bg-clip-text text-transparent">
                  ForgeLabs
                </div>
              </div>
            </div>
