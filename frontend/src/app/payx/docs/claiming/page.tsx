        ...
        <div className="space-y-4">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-[#01C38E]/20 rounded-lg flex items-center justify-center text-[#01C38E] font-bold shrink-0">1</div>
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Visit Claim Page</h3>
                <p className="text-gray-400 text-sm mb-3">
                  Go to <a href="/payx/claim" className="text-[#01C38E] hover:text-[#01C38E]">/payx/claim</a> on PayX
                </p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-[#0A786A]/20 rounded-lg flex items-center justify-center text-[#0A786A] font-bold shrink-0">2</div>
              <div>
...
require(signer == oracleSigner, "Invalid signature");`}
      ...
      <section className="mb-12">
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6">
          <p className="text-gray-300 mb-4">
            Successful claims emit a <code className="text-[#0A786A] bg-[#0A786A]/10 px-2 py-0.5 rounded">TipsClaimed</code> event:
          </p>
          <div className="bg-[#0a0b0f] rounded-lg p-4 font-mono text-sm overflow-x-auto">
            <pre className="text-gray-300">
{`event TipsClaimed(
